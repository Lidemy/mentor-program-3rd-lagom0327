...
<html>
  ...
  <p>本站為練習用網站，因教學用途刻意忽略資安的實作，註冊時請勿使用任何真實的帳號或密碼</p>
   <?php if(!isset($_COOKIE["user_id"])) {
    echo "    <nav><a href='./index.php'>Message board</a><a href='./login.php'>登入</a><a href='./register.php'>註冊</a></nav>";
    echo "<h1>如需留言請登入</h1>";
} else {
  $id = $_COOKIE["user_id"];
  ...
  echo "    <nav><a href='./index.php'>Message board</a><a href='./handle_logout.php'>登出</a></nav>";
    echo "<h1>Hello ~ " . $row['nickname'] . "</h1>";
} ?>
